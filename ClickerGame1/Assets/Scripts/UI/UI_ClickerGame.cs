...
public class UI_ClickerGame : UI_Base
{
    ...
    private Button _gameAreaButton;
    ...
    protected override void Awake()
    {
        ...
        // Ensure GameArea has a Button component to receive clicks
        if (_gameArea != null)
        {
            _gameAreaButton = _gameArea.GetComponent<Button>();
            if (_gameAreaButton == null)
            {
                // Add a Button component if missing so clicks are registered
                _gameAreaButton = _gameArea.AddComponent<Button>();
                // Disable transition by default if no graphic
                _gameAreaButton.transition = Selectable.Transition.None;
            }
        }
    }
    ...
    protected override void BindUIEvents()
    {
        ...
        // Bind GameArea click event ? use the current GoldPerClick at click time
        if (_gameAreaButton != null)
        {
            _gameAreaButton.onClick.RemoveAllListeners();
            _gameAreaButton.onClick.AddListener(() => AddGold());
        }
    }
    ...
    {
        // Always read the current GoldPerClick value when adding
